...
public class SongController {
    ...
    public String update(@Valid @ModelAttribute SongDto song, BindingResult bindingResult, RedirectAttributes redirectAttributes, UriComponentsBuilder uriBuilder, Locale locale) throws MusicianNameNullException {
